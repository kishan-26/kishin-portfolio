            ...
            >
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                {project.id === 'dsa-tracker-tool' ? (
                  <div className="p-4 rounded-2xl bg-[#090214] border border-[#ff7edb]/25 space-y-3">
                    <div className="flex items-center justify-between text-[11px] font-mono">
                      ...
                      <span className="text-[#a73be2]">SM-2 Algorithm</span>
                    </div>
                  ...
                  <div className="p-4 rounded-2xl bg-[#090214] border border-[#ff7edb]/25 space-y-3">
                    <div className="flex items-center justify-between text-[11px] font-mono">
                      ...
                      <span className="text-[#a73be2]">0.5V – 3.0V</span>
                    </div>
                ...
                <div className="p-4 rounded-2xl bg-[#ff7edb]/5 dark:bg-[#180a2d] border border-[#ff7edb]/20 text-xs text-slate-700 dark:text-[#ffeaf9] space-y-1">
                  ...
                  <p className="leading-relaxed dark:text-[#ffeaf9]/80">{project.problemSolved}</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-2">
                    {project.highlights.slice(0, 3).map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2.5 text-xs text-[#ffeaf9]/85">
                ...
                {project.stats && (
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    {project.stats.map((stat, i) => (
                      <div key={i} className="p-2.5 rounded-xl bg-[#ff7edb]/5 dark:bg-[#180a2d] border border-[#ff7edb]/10 text-center">
              ...
              <div className="p-6 bg-[#0f041d] border-t border-[#ff7edb]/15 space-y-4">
                ...
                {/* Action Buttons: Deep Dive + Direct GitHub Repo Button */}
                <div className="flex items-center gap-2.5">
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      title="Open GitHub Repository (dsa-master)"
                    >
